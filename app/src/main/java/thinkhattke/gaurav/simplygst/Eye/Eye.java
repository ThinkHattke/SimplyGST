package thinkhattke.gaurav.simplygst.Eye;
...
public class Eye extends AppCompatActivity {
    ...
    private final String LOG_TAG = "Eye Activity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImageButton.setOnClickListener(v -> ActivityCompat.requestPermissions(Eye.this,
                new String[]{Manifest.permission.GET_ACCOUNTS},
                REQUEST_PERMISSIONS));


        verifyStoragePermissions(Eye.this);
        ...
        switch (requestCode) {
            case REQUEST_PERMISSIONS:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Eye.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new GetTokenTask(Eye.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
    ...
    public void onBackPressed() {
        ...
        Intent i = new Intent(Eye.this, MainActivity.class);
        startActivity(i);
        finish();
